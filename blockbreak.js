...
//  Q.load(['blockbreak.png','blockbreak.json'], function() {
  Q.load(['blockbreak.png','paddleHit.mp3', 'blockHit.mp3', 'wallHit.mp3', 'yay.mp3',
    ...
    Q.scene('game', new Q.Scene(function(stage) {
      ...
      var scoreBoard = stage.insert(new Q.UI.Text( { label: "score: " + score, color: 'white', x:40, y:15,  size:16, type: 'Q.SPRITE_UI' } ));
	  var livesBoard = stage.insert(new Q.UI.Text( { label: "lives: " + lives, color: 'white', x:Q.width - 60, y:15,  size:16, type: 'Q.SPRITE_UI' } ));
